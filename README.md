...
Handoff 面向频繁使用 AI 编程助手的工程团队。核心对象包括 `Requirement Capsule`、`Capsule`、`Knowledge Capsule` 和 `Team Memory`。需求资料先被分析成结构化 Requirement Capsule，AI 对话再保存为可恢复 Capsule，高质量交流继续抽取为 Knowledge Capsule，最后汇总为 Team Memory。
